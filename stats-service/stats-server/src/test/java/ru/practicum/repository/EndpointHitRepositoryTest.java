...
public class EndpointHitRepositoryTest {
    ...
    private EndpointHitEntity ep16;
    private EndpointHitEntity ep17;
    private EndpointHitEntity ep18;
...
//      192.163.0.1
        ...
        //      "/events/4"
        //      192.163.0.1
        ep16 = EndpointHitEntity.builder().app("ewm-main-service")
                .uri("/events/4")
                .ip("192.163.0.1")
                .hitTime(LocalDateTime.parse("2014-04-04 20:00:00", formatter))
                .build();
        ep17 = EndpointHitEntity.builder().app("ewm-main-service")
                .uri("/events/4")
                .ip("192.163.0.1")
                .hitTime(LocalDateTime.parse("2014-04-05 20:00:00", formatter))
                .build();
        ep18 = EndpointHitEntity.builder().app("ewm-main-service")
                .uri("/events/4")
                .ip("192.163.0.1")
                .hitTime(LocalDateTime.parse("2014-04-06 20:00:00", formatter))
                .build();
    ...
    private void insertAllEndpointHits() {
        ...
        repository.save(ep16);
        repository.save(ep17);
        repository.save(ep18);
    }
    ...
    public void shouldFindAllByUriInAndHitTimeBetween() {
        ...
        TypedQuery<ViewStats> queryViewStats = em.createQuery(
                "select\n" +
                ...
                ViewStats.class);
        List<ViewStats> vsFromQuery = queryViewStats.setParameter("uris", uris)
                .setParameter("start", start)
                .setParameter("end", end)
                .getResultList();

        assertThat(list, samePropertyValuesAs(vsFromQuery));
    ...
    @Test
    public void shouldFindAllByHitTimeBetween() {
        insertAllEndpointHits();
